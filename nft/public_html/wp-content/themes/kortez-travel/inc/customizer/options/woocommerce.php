...
Kirki::add_field( 'kortez-travel', array(
    'label'       => esc_html__( 'General / Style', 'kortez-travel' ),
    'type'        => 'radio-buttonset',
    'settings'    => 'woocommerce_product_catalog_tabs',
    'section'     => 'woocommerce_product_catalog',
    'default'     => 'product_catalog_general_tab',
    'choices'  => array(
        'product_catalog_general_tab'     => esc_html__( 'General', 'kortez-travel' ),
        'product_catalog_style_tab'     => esc_html__( 'Style', 'kortez-travel' ),
    ),
) );

Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Disable Shop Page Title', 'kortez-travel' ),
    'type'         => 'checkbox',
...
Kirki::add_field( 'kortez-travel', array(
    ...
    'section'     => 'woocommerce_product_catalog',
    'default'     => esc_html__( 'Product Wrapper Options', 'kortez-travel' ),
    'priority'    => 20,
    'active_callback' => array(
        array(
            'setting'  => 'woocommerce_product_catalog_tabs',
...
Kirki::add_field( 'kortez-travel', array(
    'label'         => esc_html__( 'Product Layout Type', 'kortez-travel' ),
    'type'          => 'radio-image',
...
Kirki::add_field( 'kortez-travel', array(
    'label'         => esc_html__( 'Product Card Layout', 'kortez-travel' ),
    'type'          => 'radio-image',
...
Kirki::add_field( 'kortez-travel', array(
    'label'         => esc_html__( 'Text Alignment', 'kortez-travel' ),
    'type'          => 'select',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Products Per Row', 'kortez-travel' ),
    'description'  => esc_html__( 'How many products should be shown per row?', 'kortez-travel' ),
    'type'         => 'number',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Product Display Per Page', 'kortez-travel' ),
    'type'         => 'number',
...
Kirki::add_field( 'kortez-travel', array(
    ...
    'section'     => 'woocommerce_product_catalog',
    'default'     => esc_html__( 'Add To Cart Button Options', 'kortez-travel' ),
    'priority'    => 90,
    'active_callback' => array(
        array(
            'setting'  => 'woocommerce_product_catalog_tabs',
...
Kirki::add_field( 'kortez-travel', array(
    'label'         => esc_html__( 'Add To Cart Button Layout', 'kortez-travel' ),
    'type'          => 'radio-image',
...
Kirki::add_field( 'kortez-travel', array(
    ...
    'section'     => 'woocommerce_product_catalog',
    'default'     => esc_html__( 'Icon Group Options', 'kortez-travel' ),
    'priority'    => 110,
    'active_callback' => array(
        array(
            'setting'  => 'woocommerce_product_catalog_tabs',
...
Kirki::add_field( 'kortez-travel', array(
    'label'         => esc_html__( 'Icon Group Layout', 'kortez-travel' ),
    'description'   => esc_html__( 'Yith WooCommerce Compare, Wishlist and Quick View are grouped together. Install these plugins to use this option.', 'kortez-travel' ),
    'type'          => 'radio-image',
...
Kirki::add_field( 'kortez-travel', array(
    ...
    'section'     => 'woocommerce_product_catalog',
    'default'     => esc_html__( 'Sale Tag Options', 'kortez-travel' ),
    'priority'    => 130,
    'active_callback' => array(
        array(
            'setting'  => 'woocommerce_product_catalog_tabs',
...
Kirki::add_field( 'kortez-travel', array(
    'label'         => esc_html__( 'Sale Tag Layout', 'kortez-travel' ),
    'type'          => 'radio-image',
...
Kirki::add_field( 'kortez-travel', array(
    'label'       => esc_html__( 'Sale Badge Text', 'kortez-travel' ),
    'type'        => 'text',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Enable Sale Badge Percentage', 'kortez-travel' ),
    'description' => esc_html__( 'Replaces sale badge text with sale percent.', 'kortez-travel' ),
    'type'         => 'checkbox',
...
Kirki::add_field( 'kortez-travel', array(
    'label'       => esc_html__( 'Sale Badge Percentage Text', 'kortez-travel' ),
    'description' => esc_html__( 'Input text to accompany with percentage {value} tag. Example: {value}% OFF!', 'kortez-travel' ),
    'type'        => 'text',
...
Kirki::add_field( 'kortez-travel', array(
    'label'         => esc_html__( 'Product Card Style', 'kortez-travel' ),
    'type'          => 'radio-image',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Product Image Radius', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Product Card Border Radius', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Add to Cart Button Background Color', 'kortez-travel' ),
    'type'         => 'color',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Add to Cart Button Text Color', 'kortez-travel' ),
    'type'         => 'color',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Add to Cart Button Radius', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Add to Cart Button Spacing', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Icon Group Background Color', 'kortez-travel' ),
    'type'         => 'color',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Icon Color', 'kortez-travel' ),
    'type'         => 'color',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Icon Group Border Radius', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Icon Group Spacing', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Sale Tag Background Color', 'kortez-travel' ),
    'type'         => 'color',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Sale Tag Text Color', 'kortez-travel' ),
    'type'         => 'color',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Sale Button Border Radius', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Sale Button Spacing', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Product Title Typography', 'kortez-travel' ),
    'type'         => 'typography',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Product Price Typography', 'kortez-travel' ),
    'type'         => 'typography',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Add to Cart Button Typography', 'kortez-travel' ),
    'type'         => 'typography',
...
Kirki::add_section( 'woocommerce_single_product', array(
    'title'      => esc_html__( 'Single Products', 'kortez-travel' ),
    'panel'      => 'woocommerce',     
    'capability' => 'edit_theme_options',
) );

Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Image Zoom / Magnification', 'kortez-travel' ),
    'description'  => esc_html__( 'Every slider step changes 10% zoom to the previous zoom level. For example: 1.1 zoom level is now 110% zoom.', 'kortez-travel' ),
    'type'         => 'slider',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Disable Single Product Page Title', 'kortez-travel' ),
    'type'         => 'checkbox',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Disable Breadcrumbs', 'kortez-travel' ),
    'type'         => 'checkbox',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Disable SKU', 'kortez-travel' ),
    'type'         => 'checkbox',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Disable Tags', 'kortez-travel' ),
    'type'         => 'checkbox',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Disable Product Tabs', 'kortez-travel' ),
    'type'         => 'checkbox',
...
Kirki::add_field( 'kortez-travel', array(
    'label'        => esc_html__( 'Disable Related Products', 'kortez-travel' ),
    'type'         => 'checkbox',
