...
function fixed_header(){
  ...
  if ( $logo_selector && KORTEZTRAVEL.fixed_nav && KORTEZTRAVEL.fixed_header_logo ) { 
    if ( $mastheadHeight < $(window).scrollTop()){
      if ( KORTEZTRAVEL.separate_logo == '' ){
        if ( KORTEZTRAVEL.the_custom_logo !== '' ){
          $logo_selector.src = KORTEZTRAVEL.the_custom_logo;
        }
      }else{
        $( '.site-header .site-branding img' ).css( 'display' , 'block' );
        if( !KORTEZTRAVEL.mobile_fixed_nav_off || width >= 782 ){
          $logo_selector.src = KORTEZTRAVEL.separate_logo;
        }
      }
    }else{
      if ( KORTEZTRAVEL.header_two_logo !== '' && ( KORTEZTRAVEL.is_front_page || KORTEZTRAVEL.overlay_post || KORTEZTRAVEL.overlay_page ) && KORTEZTRAVEL.is_header_two ){
         $logo_selector.src = KORTEZTRAVEL.header_two_logo;
      }else if ( KORTEZTRAVEL.the_custom_logo !== '' ) {
          $logo_selector.src = KORTEZTRAVEL.the_custom_logo;
      }else if ( KORTEZTRAVEL.separate_logo !== '' ){
        $( '.site-header .site-branding img' ).css( 'display' , 'none' );
      }
    }
  }
  if ( $mastheadHeight > $( window ).scrollTop() || $( window ).scrollTop() == 0 ) {
      if ( KORTEZTRAVEL.fixed_nav && $( '#masthead.site-header' ).hasClass( 'sticky-header' )){
          $( '#masthead.site-header' ).removeClass( 'sticky-header' );
          // Fixed header in admin bar
          if( KORTEZTRAVEL.is_admin_bar_showing && width >= 782 ){
            $( '.fixed-header' ).css( 'marginTop', 0 );
          }
          if( KORTEZTRAVEL.is_admin_bar_showing && width <= 781 ){
            $( '.fixed-header' ).css( 'marginTop', 0 );
          }
      }
  }else if ( KORTEZTRAVEL.fixed_nav && !$( '#masthead.site-header' ).hasClass( 'sticky-header' )){
    if( !KORTEZTRAVEL.mobile_fixed_nav_off || width >= 782 ){
      ...
      if( KORTEZTRAVEL.is_admin_bar_showing && width <= 600 ){
        $( '.fixed-header' ).css( 'marginTop', 0 );
      }
      if( KORTEZTRAVEL.mobile_fixed_nav_off && width <= 781 ){
        $( '.fixed-header' ).css( 'marginTop', 0 );
    }
  }
}
...
jQuery( document ).ready( function() {
  ...
  */
  $( '.header-image-slider' ).slick({
      ...
      fade: KORTEZTRAVEL.header_image_slider.fade,
      speed: parseInt( KORTEZTRAVEL.header_image_slider.fadeControl ),
      cssEase: 'linear',
      autoplay: KORTEZTRAVEL.header_image_slider.autoplay,
      autoplaySpeed: KORTEZTRAVEL.header_image_slider.autoplaySpeed,
      infinite: true,
  ...
  */
  $( '#primary-menu' ).slicknav({
      ...
      label: KORTEZTRAVEL.responsive_header_menu_text,
  ...
  * Sticky sidebar
  */
  if( KORTEZTRAVEL.sticky_sidebar ){
...
jQuery( window ).on( 'load', function(){
  ...
  * Back to top
  */
  if( KORTEZTRAVEL.enable_scroll_top == true && $(window).scrollTop() > 200 ){
...
jQuery( window ).on( 'scroll', function(){
  ...
  * Back to top
  */
  if( KORTEZTRAVEL.disable_scroll_top == false && $(window).scrollTop() > 200 ){
    $( '#back-to-top' ).fadeIn( 200 );
  } else{
    $( '#back-to-top' ).fadeOut( 200 );
  }
